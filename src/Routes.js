...
import PerfilCliente from '@/pages/Clientes/PerfilCliente/PerfilCliente' 
import Dossier from '@/pages/Clientes/PerfilCliente/Dossier/Dossier'

import Estatistica from '@/pages/Estatistica/Estatistica';
import Tarefas from '@/pages/Tarefas/Tarefas'
import DetalhesTarefa from '@/pages/Tarefas/DetalhesTarefa/DetalhesTarefa'
import PerfilUtilizador from '@/pages/Utilizadores/PerfilUtilizador/PerfilUtilizador'
  ...
  routes: [
    ...
    // },
    {
      ...
      children: [
        ...
        {
          path: 'detalhestarefas/:tarefaId',
          name: 'DetalhesTarefa',
          component: DetalhesTarefa,
        },
        
        {
          path: 'perfilutilizador/:utilizadorId',
          name: 'PerfilUtilizador',
          component: PerfilUtilizador,
        },
